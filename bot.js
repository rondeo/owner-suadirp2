...
const devs = ['314343116729745408'];
const db = require('quick.db');
const premium = ['314343116729745408']
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Shelp','Suadi System','7rBH','Suadi RolePlay'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
    if(!message.channel.guild) return;
let args = message.content.split(' ').slice(1).join(' ');
if (message.content.startsWith('!nadmin')){
...
return channel.send("")
	...
	const adminprefix = "!n";
const developers = ["502509585370841098","id"]
client.on('message', message => {
